...
def create_subfolder():
    ...
    Subfolders are named by the index of their run, starting with 000.
    """
    ...
    # if first run, creates subfolder with index 000
    if len(runs_dirs) == 0:
    ...
    return os.path.join(head_folder_path, current_dir)